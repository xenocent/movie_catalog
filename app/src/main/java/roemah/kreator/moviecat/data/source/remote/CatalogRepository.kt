...
class CatalogRepository private constructor(private val remoteDataSource: CatalogRemoteDataSource) : CatalogDataSource {

    companion object {
        @Volatile
        private var instance: CatalogRepository? = null

        fun getInstance(remoteDataSource: CatalogRemoteDataSource): CatalogRepository =
