...
import roemah.kreator.moviecat.data.source.remote.response.ContentResponse
import roemah.kreator.moviecat.data.source.remote.response.CourseResponse
import roemah.kreator.moviecat.data.source.remote.response.ModuleResponse
        ...
        try {
            ...
            if (result != null) {
                ...
                for (i in 0 until listArray.length()) {
                    ...
                    Log.d("testing","load module json" + course.getString("title"))
